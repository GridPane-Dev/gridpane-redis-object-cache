...
<div class="wrap">
    ...
    <div class="section-overview">
        ...
        <h2 class="title"><?php _e( 'Redis Server Connection Status', 'gridpane-redis-object-cache' ); ?></h2>
        ...
        <p class="submit">
            ...
            <?php if ( $this->get_redis_status() ) : ?>
                <a href="<?php echo wp_nonce_url( network_admin_url( add_query_arg( 'action', 'flush-cache', $this->page ) ), 'flush-cache' ); ?>" class="button button-primary button-large flush"><?php _e( 'Flush Object Cache', 'gridpane-redis-object-cache' ); ?></a> &nbsp;
            <?php endif; ?>
